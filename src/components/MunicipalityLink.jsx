...
const MunicipalityLink = (props) => {
  ...
  return (
    props.municipality.length > 0 && <Link className={props.className} to={`/opshtina/${encodeURIComponent(cleanName(transliterate(props.municipality)).toLowerCase())}/`}>{props.municipality}
